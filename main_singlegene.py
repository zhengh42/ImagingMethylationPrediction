...
plt.close()
config = Config(folder="SG", source="glioma", models=None, clustering=None, n_tasks=1147)
#config = Config(folder="SG", source="RCC", models=None, clustering=None, n_tasks=1147)
